...
procedure jouercarte2(var j1,j2: joueur);// Permet de lancer la partie sur la carte 2

procedure jouercarte3(var j1,j2:joueur);// Permet de lancer la partie sur la carte 3
...
begin
	...
	//Affiche le gagnant selon les scores
